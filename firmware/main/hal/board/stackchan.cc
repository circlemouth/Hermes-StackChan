...
private:
    ...
    void InitializeIli9342Display()
    {
        ...
        // CoreS3 / StackChan shares the display SPI bus with the SD card pins.
        // Keep LCD transfers conservative; high clock/queue depth can leave the
        // panel showing corrupted partial frames after SD-card interaction.
